...
public class TextEditor_Reimpl
{
    ...
    private GUIContent m_Content = new();
    ...
    internal bool HandleKeyEvent(Event e, bool textIsReadOnly)
    {
        ...
        {
            LaboratoryPlugin.Instance.Log.LogMessage($"Event 2: {e.ToString()}");
    ...
    internal void UpdateScrollOffset()
    {
        ...
        Vector2 contentSize = new(style.CalcSize(m_Content).x, style.CalcHeight(m_Content, position.width));
    ...
    void InitKeyActions()
    {
        ...
        s_Keyactions = new Dictionary<Event, TextEditOp>(Il2CppEqualityComparer<Event>.Instance);
